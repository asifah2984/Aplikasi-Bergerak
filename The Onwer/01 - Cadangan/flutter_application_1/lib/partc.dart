...
class MyThree extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var gambarhpxiaomi  = "https://cdn.discordapp.com/attachments/1115253065558269952/1115294797960319167/mi-9-1568405995.jpg";
    var gambarhpredmi   = "https://cdn.discordapp.com/attachments/1115253065558269952/1115295081734348850/xiaomi-redmi-note-10-1614935406.jpg";
    var gambarhppoco    = "https://cdn.discordapp.com/attachments/1115253065558269952/1115295278740811816/xiaomi-poco-f4-1656061802.jpg";
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: Column(
              children: <Widget>[
                Image(
                  image: NetworkImage(gambarhpxiaomi),
                  height: 350,
                  width: 800,
                ),
          ...
          Container(
            ...
            child: Column(
              children: <Widget>[
                Image(
                  image: NetworkImage(gambarhpredmi),
                  height: 350,
                  width: 800,
                ),
          ...
          Container(
            ...
            child: Column(
              children: <Widget>[
                Image(
                  image: NetworkImage(gambarhppoco),
                  height: 350,
                  width: 800,
                ),
